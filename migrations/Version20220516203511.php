 ...
 */
final class Version20220516203511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `Cart` (id INT AUTO_INCREMENT NOT NULL, fkuser_id INT NOT NULL, reference VARCHAR(255) NOT NULL, fullname VARCHAR(255) NOT NULL, adressdelivery VARCHAR(255) NOT NULL, moreinformation LONGTEXT DEFAULT NULL, is_paid TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', quantity INT NOT NULL, sub_total DOUBLE PRECISION NOT NULL, INDEX IDX_AB9127897EF35C86 (fkuser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE adresse (id INT AUTO_INCREMENT NOT NULL, fkuser_id INT NOT NULL, ville VARCHAR(255) NOT NULL, fullname VARCHAR(255) NOT NULL, quartier VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, INDEX IDX_C35F08167EF35C86 (fkuser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cart_detail (id INT AUTO_INCREMENT NOT NULL, carts_id INT NOT NULL, product_name VARCHAR(255) NOT NULL, product_price DOUBLE PRECISION NOT NULL, quantity INT NOT NULL, sub_total DOUBLE PRECISION NOT NULL, INDEX IDX_20821DCCBCB5C6F5 (carts_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, fkuser_id INT NOT NULL, reference VARCHAR(255) NOT NULL, fullname VARCHAR(255) NOT NULL, adressdelivery VARCHAR(255) NOT NULL, moreinformation LONGTEXT DEFAULT NULL, is_paid TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', quantity INT NOT NULL, sub_total DOUBLE PRECISION NOT NULL, INDEX IDX_F52993987EF35C86 (fkuser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE slider_home (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, btn_url VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, is_display TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `Cart` ADD CONSTRAINT FK_AB9127897EF35C86 FOREIGN KEY (fkuser_id) REFERENCES user (id)');
        ...
        $this->addSql('ALTER TABLE cart_detail ADD CONSTRAINT FK_20821DCCBCB5C6F5 FOREIGN KEY (carts_id) REFERENCES `Cart` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart_detail DROP FOREIGN KEY FK_20821DCCBCB5C6F5');
        ...
        $this->addSql('ALTER TABLE `Cart` DROP FOREIGN KEY FK_AB9127897EF35C86');
        ...
        $this->addSql('DROP TABLE slider_home');
